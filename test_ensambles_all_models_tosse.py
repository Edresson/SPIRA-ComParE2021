...
if __name__ == '__main__':
    ...
    experiments_dir = ["../Tosse/Experiments_Final/Experiment-1","../Tosse/Experiments_Final/Experiment-2/", "../Tosse/Experiments_Final/Experiment-3/", "../Tosse/Experiments_Final/Experiment-4/", "../Tosse/Experiments_Final_one_window_Final/Experiment-1/", "../Tosse/Experiments_Final_one_window_Final/Experiment-2/", "../Tosse/Experiments_Final_one_window_Final/Experiment-3/", "../Tosse/Experiments_Final_one_window_Final/Experiment-4/","../Tosse/Experiments_Final_kfolds/Experiment-1","../Tosse/Experiments_Final_kfolds/Experiment-2/", "../Tosse/Experiments_Final_kfolds/Experiment-3/", "../Tosse/Experiments_Final_kfolds/Experiment-4/"]
...
CUDA_VISIBLE_DEVICES=0  nohup  python test_ensambles_all_models_tosse.py  --test_csv ../Tosse/dist/lab/devel.csv -r ../Tosse/dist/wav_normalized  --batch_size 30 --debug 0   --output_csv ../Tosse/Ensamble_results/ensamble_tosse_all_eval.csv  &
CUDA_VISIBLE_DEVICES=0  nohup  python test_ensambles_all_models_tosse.py  --test_csv ../Tosse/dist/lab/test.csv -r ../Tosse/dist/wav_normalized  --batch_size 30 --debug 0   --output_csv ../Tosse/Ensamble_results/ensamble_tosse_all_test.csv  &
'''
