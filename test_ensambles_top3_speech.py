...
if __name__ == '__main__':
    ...
    experiments_dir = ["../Speech/Experiments_Final/Experiment-3/", "../Speech/Experiments_Final_one_window_Final/Experiment-2/", "../Speech/Experiments_Final_kfolds/Experiment-2" ]
